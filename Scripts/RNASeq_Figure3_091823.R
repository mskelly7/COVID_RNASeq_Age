...
fsgea_np_0to5_Pos_Neg <- data.frame(read_excel("3_COVID_Pos_by_Age/modules_np_0to5_Pos_Neg.xlsx"))
fsgea_np_6to13_Pos_Neg <- data.frame(read_excel("3_COVID_Pos_by_Age/modules_np_6to13_Pos_Neg.xlsx"))
fsgea_np_14to20_Pos_Neg <- data.frame(read_excel("3_COVID_Pos_by_Age/modules_np_14to20_Pos_Neg.xlsx"))
fsgea_pax_0to5_Pos_Neg <- data.frame(read_excel("3_COVID_Pos_by_Age/modules_pax_0to5_Pos_Neg.xlsx"))
fsgea_pax_6to13_Pos_Neg <- data.frame(read_excel("3_COVID_Pos_by_Age/modules_pax_6to13_Pos_Neg.xlsx"))
fsgea_pax_14to20_Pos_Neg <- data.frame(read_excel("3_COVID_Pos_by_Age/modules_pax_14to20_Pos_Neg.xlsx"))
fsgea_pax_adult_Pos_Neg <- data.frame(read_excel("3_COVID_Pos_by_Age/modules_pax_adult_Pos_Neg.xlsx"))
...
#png(file="Figures/Figure_3.png", width = 16, height = 11, units = 'in', res = 1200)
...
png(file="Figures/Figure_3.png", width = 16, height = 11.25, units = 'in', res = 1200)
