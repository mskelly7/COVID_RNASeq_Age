...
remove(list=ls())
setwd("___________________________________") 
set.seed(1234)
...
rnaseq_metadata <- merge(metadata_brave, metadata_messi, by=c("alias_sequencing_id", "alias_study_id", "SampleTiming", "SampleType", "year", "study", "hospital", 
                                                              ...
                                                              "congestion", "headache","abd_pain","diarrhea","anosmia","dysgeusia","chestpain","myalgias","joint_pain",
                                                              "sars2_variant","neut_ID50_2mo","timing_neut_dx"), 
