...
# All models are adjusted for sequencing batch, sex, and (as applicable) age category
# Models of PAX samples are run with and without adjustment for imputed cell proportions 
...
dds_np_neg <- DESeqDataSetFromMatrix(countData = counts_np_neg, colData = metadata_np_neg, design = ~ batch_num + age_cat + sex)
...
dds_np_neg_0to5_vs_6to13 <- results(dds_np_neg, contrast=c("age_cat","0-5 years","6-13 years"))
dds_np_neg_0to5_vs_6to13 <- data.frame(EnsemblID=row.names(dds_np_neg_0to5_vs_6to13), dds_np_neg_0to5_vs_6to13)
dds_np_neg_0to5_vs_6to13 <- merge(dds_np_neg_0to5_vs_6to13, genes_np, by="row.names")
dds_np_neg_0to5_vs_6to13 <- dds_np_neg_0to5_vs_6to13[,c("EnsemblID","Gene","baseMean","log2FoldChange","lfcSE","stat","pvalue","padj")]
dds_np_neg_0to5_vs_6to13 <- subset(dds_np_neg_0to5_vs_6to13, !is.na(padj))
dds_np_neg_0to5_vs_6to13 <- dds_np_neg_0to5_vs_6to13[order(dds_np_neg_0to5_vs_6to13$padj),]
dds_np_neg_0to5_vs_6to13 <- dds_np_neg_0to5_vs_6to13 %>% 
...
dds_np_neg_0to5_vs_6to13 <- dds_np_neg_0to5_vs_6to13[order(dds_np_neg_0to5_vs_6to13$Expression, dds_np_neg_0to5_vs_6to13$log2FoldChange),]
write.csv(dds_np_neg_0to5_vs_6to13, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_np_neg_0to5_vs_6to13_nocibersort.csv", row.names=FALSE)
...
dds_np_neg_0to5_vs_14to20 <- results(dds_np_neg, contrast=c("age_cat","0-5 years","14-20 years"))
dds_np_neg_0to5_vs_14to20 <- data.frame(EnsemblID=row.names(dds_np_neg_0to5_vs_14to20), dds_np_neg_0to5_vs_14to20)
dds_np_neg_0to5_vs_14to20 <- merge(dds_np_neg_0to5_vs_14to20, genes_np, by="row.names")
dds_np_neg_0to5_vs_14to20 <- dds_np_neg_0to5_vs_14to20[,c("EnsemblID","Gene","baseMean","log2FoldChange","lfcSE","stat","pvalue","padj")]
dds_np_neg_0to5_vs_14to20 <- subset(dds_np_neg_0to5_vs_14to20, !is.na(padj))
dds_np_neg_0to5_vs_14to20 <- dds_np_neg_0to5_vs_14to20[order(dds_np_neg_0to5_vs_14to20$padj),]
dds_np_neg_0to5_vs_14to20 <- dds_np_neg_0to5_vs_14to20 %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_np_neg_0to5_vs_14to20 <- dds_np_neg_0to5_vs_14to20[order(dds_np_neg_0to5_vs_14to20$Expression, dds_np_neg_0to5_vs_14to20$log2FoldChange),]
write.csv(dds_np_neg_0to5_vs_14to20, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_np_neg_0to5_vs_14to20_nocibersort.csv", row.names=FALSE)

# Output results for 6-13 years vs. 14-20 years = genes with logFC>0 are overexpressed in children 6-13 years
# results(dds, contrast=c("condition","C","B")) = genes with logFC > 0 are overexpressed in C
dds_np_neg_6to13_vs_14to20 <- results(dds_np_neg, contrast=c("age_cat","6-13 years","14-20 years"))
dds_np_neg_6to13_vs_14to20 <- data.frame(EnsemblID=row.names(dds_np_neg_6to13_vs_14to20), dds_np_neg_6to13_vs_14to20)
dds_np_neg_6to13_vs_14to20 <- merge(dds_np_neg_6to13_vs_14to20, genes_np, by="row.names")
dds_np_neg_6to13_vs_14to20 <- dds_np_neg_6to13_vs_14to20[,c("EnsemblID","Gene","baseMean","log2FoldChange","lfcSE","stat","pvalue","padj")]
dds_np_neg_6to13_vs_14to20 <- subset(dds_np_neg_6to13_vs_14to20, !is.na(padj))
dds_np_neg_6to13_vs_14to20 <- dds_np_neg_6to13_vs_14to20[order(dds_np_neg_6to13_vs_14to20$padj),]
dds_np_neg_6to13_vs_14to20 <- dds_np_neg_6to13_vs_14to20 %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_np_neg_6to13_vs_14to20 <- dds_np_neg_6to13_vs_14to20[order(dds_np_neg_6to13_vs_14to20$Expression, dds_np_neg_6to13_vs_14to20$log2FoldChange),]
write.csv(dds_np_neg_6to13_vs_14to20, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_np_neg_6to13_vs_14to20_nocibersort.csv", row.names=FALSE)
...
# Output results for 0-5 years vs. 6-13 years = genes with logFC>0 are overexpressed in children 0-5 years
# results(dds, contrast=c("condition","C","B")) = genes with logFC > 0 are overexpressed in C
dds_pax_neg_0to5_vs_6to13 <- results(dds_pax_neg, contrast=c("age_cat","0-5 years","6-13 years"))
dds_pax_neg_0to5_vs_6to13 <- data.frame(EnsemblID=row.names(dds_pax_neg_0to5_vs_6to13), dds_pax_neg_0to5_vs_6to13)
dds_pax_neg_0to5_vs_6to13 <- merge(dds_pax_neg_0to5_vs_6to13, genes_pax, by="row.names")
dds_pax_neg_0to5_vs_6to13 <- dds_pax_neg_0to5_vs_6to13[,c("EnsemblID","Gene","baseMean","log2FoldChange","lfcSE","stat","pvalue","padj")]
dds_pax_neg_0to5_vs_6to13 <- subset(dds_pax_neg_0to5_vs_6to13, !is.na(padj))
dds_pax_neg_0to5_vs_6to13 <- dds_pax_neg_0to5_vs_6to13[order(dds_pax_neg_0to5_vs_6to13$padj),]
dds_pax_neg_0to5_vs_6to13 <- dds_pax_neg_0to5_vs_6to13 %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_0to5_vs_6to13 <- dds_pax_neg_0to5_vs_6to13[order(dds_pax_neg_0to5_vs_6to13$Expression, dds_pax_neg_0to5_vs_6to13$log2FoldChange),]
write.csv(dds_pax_neg_0to5_vs_6to13, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_0to5_vs_6to13_cibersort.csv", row.names=FALSE)

# Output results for 0-5 years vs. 14-20 years = genes with logFC>0 are overexpressed in children 0-5 years
# results(dds, contrast=c("condition","C","B")) = genes with logFC > 0 are overexpressed in C
dds_pax_neg_0to5_vs_14to20 <- results(dds_pax_neg, contrast=c("age_cat","0-5 years","14-20 years"))
dds_pax_neg_0to5_vs_14to20 <- data.frame(EnsemblID=row.names(dds_pax_neg_0to5_vs_14to20), dds_pax_neg_0to5_vs_14to20)
dds_pax_neg_0to5_vs_14to20 <- merge(dds_pax_neg_0to5_vs_14to20, genes_pax, by="row.names")
dds_pax_neg_0to5_vs_14to20 <- dds_pax_neg_0to5_vs_14to20[,c("EnsemblID","Gene","baseMean","log2FoldChange","lfcSE","stat","pvalue","padj")]
dds_pax_neg_0to5_vs_14to20 <- subset(dds_pax_neg_0to5_vs_14to20, !is.na(padj))
dds_pax_neg_0to5_vs_14to20 <- dds_pax_neg_0to5_vs_14to20[order(dds_pax_neg_0to5_vs_14to20$padj),]
dds_pax_neg_0to5_vs_14to20 <- dds_pax_neg_0to5_vs_14to20 %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_0to5_vs_14to20 <- dds_pax_neg_0to5_vs_14to20[order(dds_pax_neg_0to5_vs_14to20$Expression, dds_pax_neg_0to5_vs_14to20$log2FoldChange),]
write.csv(dds_pax_neg_0to5_vs_14to20, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_0to5_vs_14to20_cibersort.csv", row.names=FALSE)

# Output results for 6-13 years vs. 14-20 years = genes with logFC>0 are overexpressed in children 6-13 years
# results(dds, contrast=c("condition","C","B")) = genes with logFC > 0 are overexpressed in C
dds_pax_neg_6to13_vs_14to20 <- results(dds_pax_neg, contrast=c("age_cat","6-13 years","14-20 years"))
dds_pax_neg_6to13_vs_14to20 <- data.frame(EnsemblID=row.names(dds_pax_neg_6to13_vs_14to20), dds_pax_neg_6to13_vs_14to20)
dds_pax_neg_6to13_vs_14to20 <- merge(dds_pax_neg_6to13_vs_14to20, genes_pax, by="row.names")
dds_pax_neg_6to13_vs_14to20 <- dds_pax_neg_6to13_vs_14to20[,c("EnsemblID","Gene","baseMean","log2FoldChange","lfcSE","stat","pvalue","padj")]
dds_pax_neg_6to13_vs_14to20 <- subset(dds_pax_neg_6to13_vs_14to20, !is.na(padj))
dds_pax_neg_6to13_vs_14to20 <- dds_pax_neg_6to13_vs_14to20[order(dds_pax_neg_6to13_vs_14to20$padj),]
dds_pax_neg_6to13_vs_14to20 <- dds_pax_neg_6to13_vs_14to20 %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_6to13_vs_14to20 <- dds_pax_neg_6to13_vs_14to20[order(dds_pax_neg_6to13_vs_14to20$Expression, dds_pax_neg_6to13_vs_14to20$log2FoldChange),]
write.csv(dds_pax_neg_6to13_vs_14to20, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_6to13_vs_14to20_cibersort.csv", row.names=FALSE)

# Output results for 0-5 years vs. adult = genes with logFC>0 are overexpressed in children 0-5 years
# results(dds, contrast=c("condition","C","B")) = genes with logFC > 0 are overexpressed in C
dds_pax_neg_0to5_vs_adult <- results(dds_pax_neg, contrast=c("age_cat","0-5 years","Adult"))
dds_pax_neg_0to5_vs_adult <- data.frame(EnsemblID=row.names(dds_pax_neg_0to5_vs_adult), dds_pax_neg_0to5_vs_adult)
dds_pax_neg_0to5_vs_adult <- merge(dds_pax_neg_0to5_vs_adult, genes_pax, by="row.names")
dds_pax_neg_0to5_vs_adult <- dds_pax_neg_0to5_vs_adult[,c("EnsemblID","Gene","baseMean","log2FoldChange","lfcSE","stat","pvalue","padj")]
dds_pax_neg_0to5_vs_adult <- subset(dds_pax_neg_0to5_vs_adult, !is.na(padj))
dds_pax_neg_0to5_vs_adult <- dds_pax_neg_0to5_vs_adult[order(dds_pax_neg_0to5_vs_adult$padj),]
dds_pax_neg_0to5_vs_adult <- dds_pax_neg_0to5_vs_adult %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_0to5_vs_adult <- dds_pax_neg_0to5_vs_adult[order(dds_pax_neg_0to5_vs_adult$Expression, dds_pax_neg_0to5_vs_adult$log2FoldChange),]
write.csv(dds_pax_neg_0to5_vs_adult, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_0to5_vs_adult_cibersort.csv", row.names=FALSE)

# Output results for 6-13 years vs. adult = genes with logFC>0 are overexpressed in children 6-13 years
# results(dds, contrast=c("condition","C","B")) = genes with logFC > 0 are overexpressed in C
dds_pax_neg_6to13_vs_adult <- results(dds_pax_neg, contrast=c("age_cat","6-13 years","Adult"))
dds_pax_neg_6to13_vs_adult <- data.frame(EnsemblID=row.names(dds_pax_neg_6to13_vs_adult), dds_pax_neg_6to13_vs_adult)
dds_pax_neg_6to13_vs_adult <- merge(dds_pax_neg_6to13_vs_adult, genes_pax, by="row.names")
dds_pax_neg_6to13_vs_adult <- dds_pax_neg_6to13_vs_adult[,c("EnsemblID","Gene","baseMean","log2FoldChange","lfcSE","stat","pvalue","padj")]
dds_pax_neg_6to13_vs_adult <- subset(dds_pax_neg_6to13_vs_adult, !is.na(padj))
dds_pax_neg_6to13_vs_adult <- dds_pax_neg_6to13_vs_adult[order(dds_pax_neg_6to13_vs_adult$padj),]
dds_pax_neg_6to13_vs_adult <- dds_pax_neg_6to13_vs_adult %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_6to13_vs_adult <- dds_pax_neg_6to13_vs_adult[order(dds_pax_neg_6to13_vs_adult$Expression, dds_pax_neg_6to13_vs_adult$log2FoldChange),]
write.csv(dds_pax_neg_6to13_vs_adult, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_6to13_vs_adult_cibersort.csv", row.names=FALSE)

# Output results for 14-20 years vs. adult = genes with logFC>0 are overexpressed in children 14-20 years
# results(dds, contrast=c("condition","C","B")) = genes with logFC > 0 are overexpressed in C
dds_pax_neg_14to20_vs_adult <- results(dds_pax_neg, contrast=c("age_cat","14-20 years","Adult"))
dds_pax_neg_14to20_vs_adult <- data.frame(EnsemblID=row.names(dds_pax_neg_14to20_vs_adult), dds_pax_neg_14to20_vs_adult)
dds_pax_neg_14to20_vs_adult <- merge(dds_pax_neg_14to20_vs_adult, genes_pax, by="row.names")
dds_pax_neg_14to20_vs_adult <- dds_pax_neg_14to20_vs_adult[,c("EnsemblID","Gene","baseMean","log2FoldChange","lfcSE","stat","pvalue","padj")]
dds_pax_neg_14to20_vs_adult <- subset(dds_pax_neg_14to20_vs_adult, !is.na(padj))
dds_pax_neg_14to20_vs_adult <- dds_pax_neg_14to20_vs_adult[order(dds_pax_neg_14to20_vs_adult$padj),]
dds_pax_neg_14to20_vs_adult <- dds_pax_neg_14to20_vs_adult %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_14to20_vs_adult <- dds_pax_neg_14to20_vs_adult[order(dds_pax_neg_14to20_vs_adult$Expression, dds_pax_neg_14to20_vs_adult$log2FoldChange),]
write.csv(dds_pax_neg_14to20_vs_adult, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_14to20_vs_adult_cibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_neg)
all(rownames(metadata_pax_neg) == colnames(counts_pax_neg))
dds_pax_neg <- DESeqDataSetFromMatrix(countData = counts_pax_neg, colData = metadata_pax_neg, design = ~ batch_num + age_cat + sex)
...
dds_pax_neg_0to5_vs_6to13 <- dds_pax_neg_0to5_vs_6to13 %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_0to5_vs_6to13 <- dds_pax_neg_0to5_vs_6to13[order(dds_pax_neg_0to5_vs_6to13$Expression, dds_pax_neg_0to5_vs_6to13$log2FoldChange),]
write.csv(dds_pax_neg_0to5_vs_6to13, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_0to5_vs_6to13_nocibersort.csv", row.names=FALSE)
...
dds_pax_neg_0to5_vs_14to20 <- dds_pax_neg_0to5_vs_14to20 %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_0to5_vs_14to20 <- dds_pax_neg_0to5_vs_14to20[order(dds_pax_neg_0to5_vs_14to20$Expression, dds_pax_neg_0to5_vs_14to20$log2FoldChange),]
write.csv(dds_pax_neg_0to5_vs_14to20, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_0to5_vs_14to20_nocibersort.csv", row.names=FALSE)
...
dds_pax_neg_6to13_vs_14to20 <- dds_pax_neg_6to13_vs_14to20 %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_6to13_vs_14to20 <- dds_pax_neg_6to13_vs_14to20[order(dds_pax_neg_6to13_vs_14to20$Expression, dds_pax_neg_6to13_vs_14to20$log2FoldChange),]
write.csv(dds_pax_neg_6to13_vs_14to20, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_6to13_vs_14to20_nocibersort.csv", row.names=FALSE)
...
dds_pax_neg_0to5_vs_adult <- dds_pax_neg_0to5_vs_adult %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_0to5_vs_adult <- dds_pax_neg_0to5_vs_adult[order(dds_pax_neg_0to5_vs_adult$Expression, dds_pax_neg_0to5_vs_adult$log2FoldChange),]
write.csv(dds_pax_neg_0to5_vs_adult, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_0to5_vs_adult_nocibersort.csv", row.names=FALSE)
...
dds_pax_neg_6to13_vs_adult <- dds_pax_neg_6to13_vs_adult %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_6to13_vs_adult <- dds_pax_neg_6to13_vs_adult[order(dds_pax_neg_6to13_vs_adult$Expression, dds_pax_neg_6to13_vs_adult$log2FoldChange),]
write.csv(dds_pax_neg_6to13_vs_adult, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_6to13_vs_adult_nocibersort.csv", row.names=FALSE)
...
dds_pax_neg_14to20_vs_adult <- dds_pax_neg_14to20_vs_adult %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_neg_14to20_vs_adult <- dds_pax_neg_14to20_vs_adult[order(dds_pax_neg_14to20_vs_adult$Expression, dds_pax_neg_14to20_vs_adult$log2FoldChange),]
write.csv(dds_pax_neg_14to20_vs_adult, "Statistical_Analyses/1_COVID_Neg_by_Age/genes_pax_neg_14to20_vs_adult_nocibersort.csv", row.names=FALSE)
...
dds_np <- DESeqDataSetFromMatrix(countData = counts_np, colData = metadata_np, design = ~ batch_num + age_cat + sex + corona)
...
write.csv(dds_np_pos_neg, "Statistical_Analyses/2_COVID_Pos_vs_Neg/genes_np_pos_neg_nocibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_pos_neg, "Statistical_Analyses/2_COVID_Pos_vs_Neg/genes_pax_pos_neg_cibersort.csv", row.names=FALSE)
...
# Would need to scale age variable if included as continuous in models
#metadata_pax$age_scale <- scale(metadata_pax$age, center = TRUE, scale=TRUE)
dds_pax <- DESeqDataSetFromMatrix(countData = counts_pax, colData = metadata_pax, design = ~ batch_num + age_cat + sex + corona)
...
dds_pax_pos_neg <- dds_pax_pos_neg %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_pos_neg <- dds_pax_pos_neg[order(dds_pax_pos_neg$Expression, dds_pax_pos_neg$log2FoldChange),]
write.csv(dds_pax_pos_neg, "Statistical_Analyses/2_COVID_Pos_vs_Neg/genes_pax_pos_neg_nocibersort.csv", row.names=FALSE)
...
dds_np_0to5 <- DESeqDataSetFromMatrix(countData = counts_np_0to5, colData = metadata_np_0to5, design = ~ batch_num + sex + corona)
...
write.csv(dds_np_0to5_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_np_0to5_pos_neg_nocibersort.csv", row.names=FALSE)

# 6-13 years

nrow(metadata_np_6to13)
all(rownames(metadata_np_6to13) == colnames(counts_np_6to13))
dds_np_6to13 <- DESeqDataSetFromMatrix(countData = counts_np_6to13, colData = metadata_np_6to13, design = ~ batch_num + sex + corona)
...
write.csv(dds_np_6to13_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_np_6to13_pos_neg_nocibersort.csv", row.names=FALSE)

# 14-20 years

nrow(metadata_np_14to20)
all(rownames(metadata_np_14to20) == colnames(counts_np_14to20))
dds_np_14to20 <- DESeqDataSetFromMatrix(countData = counts_np_14to20, colData = metadata_np_14to20, design = ~ batch_num + sex + corona)
...
write.csv(dds_np_14to20_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_np_14to20_pos_neg_nocibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_0to5_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_pax_0to5_pos_neg_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_6to13_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_pax_6to13_pos_neg_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_14to20_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_pax_14to20_pos_neg_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_adult_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_pax_adult_pos_neg_cibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_0to5)
all(rownames(metadata_pax_0to5) == colnames(counts_pax_0to5))
dds_pax_0to5 <- DESeqDataSetFromMatrix(countData = counts_pax_0to5, colData = metadata_pax_0to5, design = ~ batch_num + sex + corona)
...
dds_pax_0to5_pos_neg <- dds_pax_0to5_pos_neg %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_0to5_pos_neg <- dds_pax_0to5_pos_neg[order(dds_pax_0to5_pos_neg$Expression, dds_pax_0to5_pos_neg$log2FoldChange),]
write.csv(dds_pax_0to5_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_pax_0to5_pos_neg_nocibersort.csv", row.names=FALSE)

# 6-13 years

nrow(metadata_pax_6to13)
all(rownames(metadata_pax_6to13) == colnames(counts_pax_6to13))
dds_pax_6to13 <- DESeqDataSetFromMatrix(countData = counts_pax_6to13, colData = metadata_pax_6to13, design = ~ batch_num + sex + corona)
...
dds_pax_6to13_pos_neg <- dds_pax_6to13_pos_neg %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_6to13_pos_neg <- dds_pax_6to13_pos_neg[order(dds_pax_6to13_pos_neg$Expression, dds_pax_6to13_pos_neg$log2FoldChange),]
write.csv(dds_pax_6to13_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_pax_6to13_pos_neg_nocibersort.csv", row.names=FALSE)

# 14-20 years

nrow(metadata_pax_14to20)
all(rownames(metadata_pax_14to20) == colnames(counts_pax_14to20))
dds_pax_14to20 <- DESeqDataSetFromMatrix(countData = counts_pax_14to20, colData = metadata_pax_14to20, design = ~ batch_num + sex + corona)
...
dds_pax_14to20_pos_neg <- dds_pax_14to20_pos_neg %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_14to20_pos_neg <- dds_pax_14to20_pos_neg[order(dds_pax_14to20_pos_neg$Expression, dds_pax_14to20_pos_neg$log2FoldChange),]
write.csv(dds_pax_14to20_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_pax_14to20_pos_neg_nocibersort.csv", row.names=FALSE)

# Adult

nrow(metadata_pax_adult)
all(rownames(metadata_pax_adult) == colnames(counts_pax_adult))
dds_pax_adult <- DESeqDataSetFromMatrix(countData = counts_pax_adult, colData = metadata_pax_adult, design = ~ batch_num + sex + corona)
...
dds_pax_adult_pos_neg <- dds_pax_adult_pos_neg %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_adult_pos_neg <- dds_pax_adult_pos_neg[order(dds_pax_adult_pos_neg$Expression, dds_pax_adult_pos_neg$log2FoldChange),]
write.csv(dds_pax_adult_pos_neg, "Statistical_Analyses/3_COVID_Pos_by_Age/genes_pax_adult_pos_neg_nocibersort.csv", row.names=FALSE)
...
dds_np_fever <- DESeqDataSetFromMatrix(countData = counts_np_fever, colData = metadata_np_fever, design = ~ batch_num + sex + age_cat + fever)
# Require a normalized count of at least 10 in two or more samples
...
write.csv(dds_np_fever, "Statistical_Analyses/4_Symptoms/genes_np_fever_nocibersort.csv", row.names=FALSE)
...
dds_np_cough <- DESeqDataSetFromMatrix(countData = counts_np_cough, colData = metadata_np_cough, design = ~ batch_num + sex + age_cat + cough)
# Require a normalized count of at least 10 in two or more samples
...
write.csv(dds_np_cough, "Statistical_Analyses/4_Symptoms/genes_np_cough_nocibersort.csv", row.names=FALSE)
...
dds_np_rhinorrhea <- DESeqDataSetFromMatrix(countData = counts_np_rhinorrhea, colData = metadata_np_rhinorrhea, design = ~ batch_num + sex + age_cat + rhinorrhea)
# Require a normalized count of at least 10 in two or more samples
...
write.csv(dds_np_rhinorrhea, "Statistical_Analyses/4_Symptoms/genes_np_rhinorrhea_nocibersort.csv", row.names=FALSE)
...
dds_np_congestion <- DESeqDataSetFromMatrix(countData = counts_np_congestion, colData = metadata_np_congestion, design = ~ batch_num + sex + age_cat + congestion)
# Require a normalized count of at least 10 in two or more samples
...
write.csv(dds_np_congestion, "Statistical_Analyses/4_Symptoms/genes_np_congestion_nocibersort.csv", row.names=FALSE)
...
dds_np_headache <- DESeqDataSetFromMatrix(countData = counts_np_headache, colData = metadata_np_headache, design = ~ batch_num + sex + age_cat + headache)
# Require a normalized count of at least 10 in two or more samples
...
write.csv(dds_np_headache, "Statistical_Analyses/4_Symptoms/genes_np_headache_nocibersort.csv", row.names=FALSE)
...
dds_np_abd_pain <- DESeqDataSetFromMatrix(countData = counts_np_abd_pain, colData = metadata_np_abd_pain, design = ~ batch_num + sex + age_cat + abd_pain)
# Require a normalized count of at least 10 in two or more samples
...
write.csv(dds_np_abd_pain, "Statistical_Analyses/4_Symptoms/genes_np_abd_pain_nocibersort.csv", row.names=FALSE)
...
dds_np_anosmia <- DESeqDataSetFromMatrix(countData = counts_np_anosmia, colData = metadata_np_anosmia, design = ~ batch_num + sex + age_cat + anosmia)
# Require a normalized count of at least 10 in two or more samples
...
write.csv(dds_np_anosmia, "Statistical_Analyses/4_Symptoms/genes_np_anosmia_nocibersort.csv", row.names=FALSE)
...
dds_np_dysgeusia <- DESeqDataSetFromMatrix(countData = counts_np_dysgeusia, colData = metadata_np_dysgeusia, design = ~ batch_num + sex + age_cat + dysgeusia)
# Require a normalized count of at least 10 in two or more samples
...
write.csv(dds_np_dysgeusia, "Statistical_Analyses/4_Symptoms/genes_np_dysgeusia_nocibersort.csv", row.names=FALSE)
...
dds_np_myalgias <- DESeqDataSetFromMatrix(countData = counts_np_myalgias, colData = metadata_np_myalgias, design = ~ batch_num + sex + age_cat + myalgias)
# Require a normalized count of at least 10 in two or more samples
...
write.csv(dds_np_myalgias, "Statistical_Analyses/4_Symptoms/genes_np_myalgias_nocibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_fever, "Statistical_Analyses/4_Symptoms/genes_pax_fever_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_cough, "Statistical_Analyses/4_Symptoms/genes_pax_cough_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_rhinorrhea, "Statistical_Analyses/4_Symptoms/genes_pax_rhinorrhea_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_congestion, "Statistical_Analyses/4_Symptoms/genes_pax_congestion_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_headache, "Statistical_Analyses/4_Symptoms/genes_pax_headache_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_abd_pain, "Statistical_Analyses/4_Symptoms/genes_pax_abd_pain_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_anosmia, "Statistical_Analyses/4_Symptoms/genes_pax_anosmia_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_dysgeusia, "Statistical_Analyses/4_Symptoms/genes_pax_dysgeusia_cibersort.csv", row.names=FALSE)
...
write.csv(dds_pax_myalgias, "Statistical_Analyses/4_Symptoms/genes_pax_myalgias_cibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_fever)
all(rownames(metadata_pax_fever) == colnames(counts_pax_fever))
dds_pax_fever <- DESeqDataSetFromMatrix(countData = counts_pax_fever, colData = metadata_pax_fever, design = ~ batch_num + sex + age_cat + fever)
# Require a normalized count of at least 10 in two or more samples
dds_pax_fever_norm <- estimateSizeFactors(dds_pax_fever)
dds_pax_fever_norm <- counts(dds_pax_fever_norm, normalized=TRUE)
filter <- rowSums(dds_pax_fever_norm >= 10) >= (nrow(metadata_pax_fever))*0.25 # require a normalized count of 10 in at least 25% of samples
...
dds_pax_fever <- dds_pax_fever %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_fever <- dds_pax_fever[order(dds_pax_fever$Expression, dds_pax_fever$log2FoldChange),]
write.csv(dds_pax_fever, "Statistical_Analyses/4_Symptoms/genes_pax_fever_nocibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_cough)
all(rownames(metadata_pax_cough) == colnames(counts_pax_cough))
dds_pax_cough <- DESeqDataSetFromMatrix(countData = counts_pax_cough, colData = metadata_pax_cough, design = ~ batch_num + sex + age_cat + cough)
# Require a normalized count of at least 10 in two or more samples
dds_pax_cough_norm <- estimateSizeFactors(dds_pax_cough)
dds_pax_cough_norm <- counts(dds_pax_cough_norm, normalized=TRUE)
filter <- rowSums(dds_pax_cough_norm >= 10) >= (nrow(metadata_pax_cough))*0.25 # require a normalized count of 10 in at least 25% of samples
...
dds_pax_cough <- dds_pax_cough %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_cough <- dds_pax_cough[order(dds_pax_cough$Expression, dds_pax_cough$log2FoldChange),]
write.csv(dds_pax_cough, "Statistical_Analyses/4_Symptoms/genes_pax_cough_nocibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_rhinorrhea)
all(rownames(metadata_pax_rhinorrhea) == colnames(counts_pax_rhinorrhea))
dds_pax_rhinorrhea <- DESeqDataSetFromMatrix(countData = counts_pax_rhinorrhea, colData = metadata_pax_rhinorrhea, design = ~ batch_num + sex + age_cat + rhinorrhea)
# Require a normalized count of at least 10 in two or more samples
dds_pax_rhinorrhea_norm <- estimateSizeFactors(dds_pax_rhinorrhea)
dds_pax_rhinorrhea_norm <- counts(dds_pax_rhinorrhea_norm, normalized=TRUE)
filter <- rowSums(dds_pax_rhinorrhea_norm >= 10) >= (nrow(metadata_pax_rhinorrhea))*0.25 # require a normalized count of 10 in at least 25% of samples
...
dds_pax_rhinorrhea <- dds_pax_rhinorrhea %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_rhinorrhea <- dds_pax_rhinorrhea[order(dds_pax_rhinorrhea$Expression, dds_pax_rhinorrhea$log2FoldChange),]
write.csv(dds_pax_rhinorrhea, "Statistical_Analyses/4_Symptoms/genes_pax_rhinorrhea_nocibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_congestion)
all(rownames(metadata_pax_congestion) == colnames(counts_pax_congestion))
dds_pax_congestion <- DESeqDataSetFromMatrix(countData = counts_pax_congestion, colData = metadata_pax_congestion, design = ~ batch_num + sex + age_cat + congestion)
# Require a normalized count of at least 10 in two or more samples
dds_pax_congestion_norm <- estimateSizeFactors(dds_pax_congestion)
dds_pax_congestion_norm <- counts(dds_pax_congestion_norm, normalized=TRUE)
filter <- rowSums(dds_pax_congestion_norm >= 10) >= (nrow(metadata_pax_congestion))*0.25 # require a normalized count of 10 in at least 25% of samples
...
dds_pax_congestion <- dds_pax_congestion %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_congestion <- dds_pax_congestion[order(dds_pax_congestion$Expression, dds_pax_congestion$log2FoldChange),]
write.csv(dds_pax_congestion, "Statistical_Analyses/4_Symptoms/genes_pax_congestion_nocibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_headache)
all(rownames(metadata_pax_headache) == colnames(counts_pax_headache))
dds_pax_headache <- DESeqDataSetFromMatrix(countData = counts_pax_headache, colData = metadata_pax_headache, design = ~ batch_num + sex + age_cat + headache)
# Require a normalized count of at least 10 in two or more samples
dds_pax_headache_norm <- estimateSizeFactors(dds_pax_headache)
dds_pax_headache_norm <- counts(dds_pax_headache_norm, normalized=TRUE)
filter <- rowSums(dds_pax_headache_norm >= 10) >= (nrow(metadata_pax_headache))*0.25 # require a normalized count of 10 in at least 25% of samples
...
dds_pax_headache <- dds_pax_headache %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_headache <- dds_pax_headache[order(dds_pax_headache$Expression, dds_pax_headache$log2FoldChange),]
write.csv(dds_pax_headache, "Statistical_Analyses/4_Symptoms/genes_pax_headache_nocibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_abd_pain)
all(rownames(metadata_pax_abd_pain) == colnames(counts_pax_abd_pain))
dds_pax_abd_pain <- DESeqDataSetFromMatrix(countData = counts_pax_abd_pain, colData = metadata_pax_abd_pain, design = ~ batch_num + sex + age_cat + abd_pain)
# Require a normalized count of at least 10 in two or more samples
dds_pax_abd_pain_norm <- estimateSizeFactors(dds_pax_abd_pain)
dds_pax_abd_pain_norm <- counts(dds_pax_abd_pain_norm, normalized=TRUE)
filter <- rowSums(dds_pax_abd_pain_norm >= 10) >= (nrow(metadata_pax_abd_pain))*0.25 # require a normalized count of 10 in at least 25% of samples
...
dds_pax_abd_pain <- dds_pax_abd_pain %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_abd_pain <- dds_pax_abd_pain[order(dds_pax_abd_pain$Expression, dds_pax_abd_pain$log2FoldChange),]
write.csv(dds_pax_abd_pain, "Statistical_Analyses/4_Symptoms/genes_pax_abd_pain_nocibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_anosmia)
all(rownames(metadata_pax_anosmia) == colnames(counts_pax_anosmia))
dds_pax_anosmia <- DESeqDataSetFromMatrix(countData = counts_pax_anosmia, colData = metadata_pax_anosmia, design = ~ batch_num + sex + age_cat + anosmia)
# Require a normalized count of at least 10 in two or more samples
dds_pax_anosmia_norm <- estimateSizeFactors(dds_pax_anosmia)
dds_pax_anosmia_norm <- counts(dds_pax_anosmia_norm, normalized=TRUE)
filter <- rowSums(dds_pax_anosmia_norm >= 10) >= (nrow(metadata_pax_anosmia))*0.25 # require a normalized count of 10 in at least 25% of samples
...
dds_pax_anosmia <- dds_pax_anosmia %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_anosmia <- dds_pax_anosmia[order(dds_pax_anosmia$Expression, dds_pax_anosmia$log2FoldChange),]
write.csv(dds_pax_anosmia, "Statistical_Analyses/4_Symptoms/genes_pax_anosmia_nocibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_dysgeusia)
all(rownames(metadata_pax_dysgeusia) == colnames(counts_pax_dysgeusia))
dds_pax_dysgeusia <- DESeqDataSetFromMatrix(countData = counts_pax_dysgeusia, colData = metadata_pax_dysgeusia, design = ~ batch_num + sex + age_cat + dysgeusia)
# Require a normalized count of at least 10 in two or more samples
dds_pax_dysgeusia_norm <- estimateSizeFactors(dds_pax_dysgeusia)
dds_pax_dysgeusia_norm <- counts(dds_pax_dysgeusia_norm, normalized=TRUE)
filter <- rowSums(dds_pax_dysgeusia_norm >= 10) >= (nrow(metadata_pax_dysgeusia))*0.25 # require a normalized count of 10 in at least 25% of samples
...
dds_pax_dysgeusia <- dds_pax_dysgeusia %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_dysgeusia <- dds_pax_dysgeusia[order(dds_pax_dysgeusia$Expression, dds_pax_dysgeusia$log2FoldChange),]
write.csv(dds_pax_dysgeusia, "Statistical_Analyses/4_Symptoms/genes_pax_dysgeusia_nocibersort.csv", row.names=FALSE)
...
nrow(metadata_pax_myalgias)
all(rownames(metadata_pax_myalgias) == colnames(counts_pax_myalgias))
dds_pax_myalgias <- DESeqDataSetFromMatrix(countData = counts_pax_myalgias, colData = metadata_pax_myalgias, design = ~ batch_num + sex + age_cat + myalgias)
# Require a normalized count of at least 10 in two or more samples
dds_pax_myalgias_norm <- estimateSizeFactors(dds_pax_myalgias)
dds_pax_myalgias_norm <- counts(dds_pax_myalgias_norm, normalized=TRUE)
filter <- rowSums(dds_pax_myalgias_norm >= 10) >= (nrow(metadata_pax_myalgias))*0.25 # require a normalized count of 10 in at least 25% of samples
...
dds_pax_myalgias <- dds_pax_myalgias %>% 
  mutate(Expression = case_when(log2FoldChange >= 0.5 & padj <= 0.05 ~ "Up-regulated", log2FoldChange <= -0.5 & padj <= 0.05 ~ "Down-regulated", TRUE ~ "Unchanged"))
dds_pax_myalgias <- dds_pax_myalgias[order(dds_pax_myalgias$Expression, dds_pax_myalgias$log2FoldChange),]
write.csv(dds_pax_myalgias, "Statistical_Analyses/4_Symptoms/genes_pax_myalgias_nocibersort.csv", row.names=FALSE)