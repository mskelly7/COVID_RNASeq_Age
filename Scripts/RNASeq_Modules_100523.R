...
dds_np_headache <- read.csv("4_Symptoms/genes_np_headache.csv")
dds_np_abd_pain <- read.csv("4_Symptoms/genes_np_abd_pain.csv")
dds_np_anosmia <- read.csv("4_Symptoms/genes_np_anosmia.csv")
dds_np_dysgeusia <- read.csv("4_Symptoms/genes_np_dysgeusia.csv")
dds_np_myalgias <- read.csv("4_Symptoms/genes_np_myalgias.csv")
...
dds_pax_headache <- read.csv("4_Symptoms/genes_pax_headache.csv")
dds_pax_abd_pain <- read.csv("4_Symptoms/genes_pax_abd_pain.csv")
dds_pax_anosmia <- read.csv("4_Symptoms/genes_pax_anosmia.csv")
dds_pax_dysgeusia <- read.csv("4_Symptoms/genes_pax_dysgeusia.csv")
dds_pax_myalgias <- read.csv("4_Symptoms/genes_pax_myalgias.csv")
...
write_xlsx(fgsea_np_headache, "4_Symptoms/modules_np_headache.xlsx")
...
write_xlsx(fgsea_np_abd_pain, "4_Symptoms/modules_np_abd_pain.xlsx")
...
write_xlsx(fgsea_np_anosmia, "4_Symptoms/modules_np_anosmia.xlsx")
...
write_xlsx(fgsea_np_dysgeusia, "4_Symptoms/modules_np_dysgeusia.xlsx")
...
write_xlsx(fgsea_np_myalgias, "4_Symptoms/modules_np_myalgias.xlsx")
...
write_xlsx(fgsea_pax_headache, "4_Symptoms/modules_pax_headache.xlsx")
...
write_xlsx(fgsea_pax_abd_pain, "4_Symptoms/modules_pax_abd_pain.xlsx")
...
write_xlsx(fgsea_pax_anosmia, "4_Symptoms/modules_pax_anosmia.xlsx")
...
write_xlsx(fgsea_pax_dysgeusia, "4_Symptoms/modules_pax_dysgeusia.xlsx")
...
write_xlsx(fgsea_pax_myalgias, "4_Symptoms/modules_pax_myalgias.xlsx")