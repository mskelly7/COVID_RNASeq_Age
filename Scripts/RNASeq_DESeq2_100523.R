...
write.csv(dds_pax_Neg_0to5_Adult, "1_COVID_Neg_by_Age/genes_pax_Neg_0to5_Adult.csv", row.names=FALSE)
...
write.csv(dds_pax_Neg_6to13_Adult, "1_COVID_Neg_by_Age/genes_pax_Neg_6to13_Adult.csv", row.names=FALSE)
...
write.csv(dds_pax_Neg_14to20_Adult, "1_COVID_Neg_by_Age/genes_pax_Neg_14to20_Adult.csv", row.names=FALSE)
...
write.csv(dds_pax_Neg_Child_Adult, "1_COVID_Neg_by_Age/genes_pax_Neg_Child_Adult.csv", row.names=FALSE)
...
write.csv(dds_np_headache, "4_Symptoms/genes_np_headache.csv", row.names=FALSE)
...
write.csv(dds_np_abd_pain, "4_Symptoms/genes_np_abd_pain.csv", row.names=FALSE)
...
write.csv(dds_np_anosmia, "4_Symptoms/genes_np_anosmia.csv", row.names=FALSE)
...
write.csv(dds_np_dysgeusia, "4_Symptoms/genes_np_dysgeusia.csv", row.names=FALSE)
...
write.csv(dds_np_myalgias, "4_Symptoms/genes_np_myalgias.csv", row.names=FALSE)
...
write.csv(dds_pax_headache, "4_Symptoms/genes_pax_headache.csv", row.names=FALSE)
...
write.csv(dds_pax_abd_pain, "4_Symptoms/genes_pax_abd_pain.csv", row.names=FALSE)
...
write.csv(dds_pax_anosmia, "4_Symptoms/genes_pax_anosmia.csv", row.names=FALSE)
...
write.csv(dds_pax_dysgeusia, "4_Symptoms/genes_pax_dysgeusia.csv", row.names=FALSE)
...
write.csv(dds_pax_myalgias, "4_Symptoms/genes_pax_myalgias.csv", row.names=FALSE)