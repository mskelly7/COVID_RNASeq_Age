...
png(file="5_NP_vs_PAX_Correlations/Correlation_plot.png", width = 7.5, height = 5, units = 'in', res = 1200)
corrplot(r_mat, type="full", order="original", p.mat = p_mat, sig.level = 0.05, insig = "blank", tl.cex = 0.62, tl.srt = 45, tl.col="black", 
         col = COL2('PuOr', 10))
...
library(magick)
fig5_plot <- image_read("5_NP_vs_PAX_Correlations/correlation_plot.png") %>% image_ggplot()
