...
fgsea_np_Neg_0to5_6to13 <- data.frame(read_excel("1_COVID_Neg_by_Age/modules_np_Neg_0to5_6to13.xlsx"))
fgsea_np_Neg_0to5_14to20 <- data.frame(read_excel("1_COVID_Neg_by_Age/modules_np_Neg_0to5_14to20.xlsx"))
fgsea_np_Neg_6to13_14to20 <- data.frame(read_excel("1_COVID_Neg_by_Age/modules_np_Neg_6to13_14to20.xlsx"))
fgsea_pax_Neg_0to5_6to13 <- data.frame(read_excel("1_COVID_Neg_by_Age/modules_pax_Neg_0to5_6to13.xlsx"))
fgsea_pax_Neg_0to5_14to20 <- data.frame(read_excel("1_COVID_Neg_by_Age/modules_pax_Neg_0to5_14to20.xlsx"))
fgsea_pax_Neg_6to13_14to20 <- data.frame(read_excel("1_COVID_Neg_by_Age/modules_pax_Neg_6to13_14to20.xlsx"))
fgsea_pax_Neg_0to5_Adult <- data.frame(read_excel("1_COVID_Neg_by_Age/modules_pax_Neg_0to5_Adult.xlsx"))
fgsea_pax_Neg_6to13_Adult <- data.frame(read_excel("1_COVID_Neg_by_Age/modules_pax_Neg_6to13_Adult.xlsx"))
fgsea_pax_Neg_14to20_Adult <- data.frame(read_excel("1_COVID_Neg_by_Age/modules_pax_Neg_14to20_Adult.xlsx"))
...
fig1_cibersort <- plot_grid(NULL, cibersort_np_neg, NULL, cibersort_pax_neg, ncol=1, labels=NULL, rel_heights=c(0.05,3,0.05,3), align="v") 
fig1_cibersort
...
png(file="Figures/Figure_1.png", width = 16.5, height = 11, units = 'in', res = 1200)
