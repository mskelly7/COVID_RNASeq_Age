...
metadata_brave <- read_excel("BRAVE_RNASeq_metadata_100523.xlsx", sheet="brave", na="NA")
metadata_messi <- read_excel("BRAVE_RNASeq_metadata_100523.xlsx", sheet="messi", na="NA")
rnaseq_metadata <- merge(metadata_brave, metadata_messi, by=c("alias_sequencing_id", "alias_study_id", "SampleTiming", "SampleType", "year", "study", "hospital", 
                                                              "batch_num", "RIN", "age", "age_cat", "sex", "race", "hispanic", "corona", "symptoms", "group", "clinical_pcr", 
                                                              "research_pcr", "vl_copies", "vaccine_doses", "timing_sx", "timing_dx",
                                                              "obesity", "comorbidity_oth", "asthma", "pulm_oth", "htn", "cardiac_oth", "diabetes", 
                                                              "neuro", "renal", "cancer", "immuno", "fever", "cough", "sob", "sorethroat", "rhinorrhea",
                                                              "congestion", "headache","abd_pain","diarrhea","anosmia","dysgeusia","chestpain","myalgias","joint_pain","sars2_variant","neut_ID50_2mo"), 
