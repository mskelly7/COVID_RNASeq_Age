...
fgsea_np_fever <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_np_fever.xlsx")
fgsea_np_fever$Variable <- "Fever"
fgsea_np_fever <- fgsea_np_fever[,vars_to_keep]
fgsea_np_cough <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_np_cough.xlsx")
fgsea_np_cough$Variable <- "Cough"
fgsea_np_cough <- fgsea_np_cough[,vars_to_keep]
fgsea_np_rhinorrhea <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_np_rhinorrhea.xlsx")
fgsea_np_rhinorrhea$Variable <- "Rhinorrhea"
fgsea_np_rhinorrhea <- fgsea_np_rhinorrhea[,vars_to_keep]
fgsea_np_congestion <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_np_congestion.xlsx")
fgsea_np_congestion$Variable <- "Congestion"
fgsea_np_congestion <- fgsea_np_congestion[,vars_to_keep]
fgsea_np_headache <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_np_headache.xlsx")
fgsea_np_headache$Variable <- "Headache"
fgsea_np_headache <- fgsea_np_headache[,vars_to_keep]
fgsea_np_abd_pain <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_np_abd_pain.xlsx")
fgsea_np_abd_pain$Variable <- "Abdominal pain"
fgsea_np_abd_pain <- fgsea_np_abd_pain[,vars_to_keep]
fgsea_np_anosmia <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_np_anosmia.xlsx")
fgsea_np_anosmia$Variable <- "Loss of smell"
fgsea_np_anosmia <- fgsea_np_anosmia[,vars_to_keep]
fgsea_np_dysgeusia <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_np_dysgeusia.xlsx")
fgsea_np_dysgeusia$Variable <- "Loss of taste"
fgsea_np_dysgeusia <- fgsea_np_dysgeusia[,vars_to_keep]
fgsea_np_myalgias <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_np_myalgias.xlsx")
...
# Load the required datasets
fgsea_pax_fever <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_pax_fever.xlsx")
fgsea_pax_fever$Variable <- "Fever"
fgsea_pax_fever <- fgsea_pax_fever[,vars_to_keep]
fgsea_pax_cough <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_pax_cough.xlsx")
fgsea_pax_cough$Variable <- "Cough"
fgsea_pax_cough <- fgsea_pax_cough[,vars_to_keep]
fgsea_pax_rhinorrhea <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_pax_rhinorrhea.xlsx")
fgsea_pax_rhinorrhea$Variable <- "Rhinorrhea"
fgsea_pax_rhinorrhea <- fgsea_pax_rhinorrhea[,vars_to_keep]
fgsea_pax_congestion <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_pax_congestion.xlsx")
fgsea_pax_congestion$Variable <- "Congestion"
fgsea_pax_congestion <- fgsea_pax_congestion[,vars_to_keep]
fgsea_pax_headache <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_pax_headache.xlsx")
fgsea_pax_headache$Variable <- "Headache"
fgsea_pax_headache <- fgsea_pax_headache[,vars_to_keep]
fgsea_pax_abd_pain <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_pax_abd_pain.xlsx")
fgsea_pax_abd_pain$Variable <- "Abdominal pain"
fgsea_pax_abd_pain <- fgsea_pax_abd_pain[,vars_to_keep]
fgsea_pax_anosmia <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_pax_anosmia.xlsx")
fgsea_pax_anosmia$Variable <- "Loss of smell"
fgsea_pax_anosmia <- fgsea_pax_anosmia[,vars_to_keep]
fgsea_pax_dysgeusia <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_pax_dysgeusia.xlsx")
fgsea_pax_dysgeusia$Variable <- "Loss of taste"
fgsea_pax_dysgeusia <- fgsea_pax_dysgeusia[,vars_to_keep]
fgsea_pax_myalgias <- read_xlsx("Statistical_Analyses/4_Symptoms/modules_pax_myalgias.xlsx")
...
png(file="Statistical_Analyses/Figures/Figure_4.png", width = 18, height = 8.4, units = 'in', res = 1200)
