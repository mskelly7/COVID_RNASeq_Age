...
figS2_plot <- plot_grid(cibersort_np, cibersort_pax, labels=c("a","b"), label_size=12, ncol=1) 
figS2_title1 <- ggdraw() + draw_label("Figure S2. Imputed sample immune cell proportions in children, adolescents,     ", size=11, fontface='bold')
figS2_title2 <- ggdraw() + draw_label("and adults with SARS-CoV-2 infection and healthy controls     ", size=11, fontface='bold')

png(file="Statistical_Analyses/Figures/Figure_S2.png", width = 6, height = 8.5, units = 'in', res = 1200)
plot_grid(figS2_title1, figS2_title2, NULL, figS2_plot, labels=NULL, ncol=1, rel_heights=c(0.03,0.03,0.02,0.97), align="v") 
dev.off()