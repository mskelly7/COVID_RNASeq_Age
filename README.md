...
- [`Data_Files`](Data_Files/)/
  ...
  - [`phy.rnaseq.np.rds`](Data_Files/phy.rnaseq.np.rds): final metadata, gene count matrix, and gene annotations for upper respiratory samples
  - [`phy.rnaseq.pax.rds`](Data_Files/phy.rnaseq.pax.rds): final metadata, gene count matrix, and gene annotations for peripheral blood samples
