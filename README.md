...
- [`Scripts`](Scripts/)/
  ...
  - [`RNASeq_Figure2.R`](Scripts/RNASeq_Figure2.R): Figure 2; inputs: DESeq2 and FGSEA output files in [`2_COVID_Pos_vs_Neg`](Output_Files/2_COVID_Pos_vs_Neg/)
  ...
  - [`RNASeq_Figure4.R`](Scripts/RNASeq_Figure4.R): Figure 4; inputs: FGSEA output files in [`4_Symptoms`](Output_Files/4_Symptoms/)
  ...
  - [`RNASeq_FigureS1.R`](Scripts/RNASeq_FigureS1.R): Supplemental Figure 1; inputs: DESeq2 output files in [`1_COVID_Neg_by_Age`](Output_Files/1_COVID_Neg_by_Age/)
  ...
  - [`RNASeq_FigureS3.R`](Scripts/RNASeq_FigureS3.R): Supplemental Figure 3; inputs: DESeq2 output files in [`3_COVID_Pos_by_Age`](Output_Files/3_COVID_Pos_by_Age/)
